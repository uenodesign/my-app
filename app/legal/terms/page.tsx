  ...
  return (
    <main className="min-h-screen bg-black text-white p-6">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <p className="text-gray-300 text-sm">本規約は、UENO DESIGN（以下「当社」）が提供する本サービスの利用条件を定めるものです。 ご利用にあたり本規約に同意いただいたものとみなします。</p>

        <section>
          <h2 className="text-lg font-semibold mb-2">1. 定義</h2>
          <p className="text-gray-300 text-sm">「本サービス」とは、Google Places 情報の検索・抽出機能および関連機能を指します。</p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 text-sm">当社は、本サービスの正確性・完全性・有用性を保証しません。利用により生じたいかなる損害についても、当社は責任を負いません。</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-2">5. 利用制限・停止</h2>
          <p className="text-gray-300 text-sm">当社は、必要と判断した場合、事前の通知なく本サービスの全部または一部の提供を停止・中断・終了できるものとします。</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-2">6. 規約の変更</h2>
          <p className="text-gray-300 text-sm">当社は、必要に応じて本規約を変更することができます。変更後の規約は、当社所定の方法で周知した時点から効力を生じます。</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-2">7. 準拠法・裁判管轄</h2>
          <p className="text-gray-300 text-sm">本規約は日本法に準拠します。本サービスに関して紛争が生じた場合、当社の所在地を第一審の専属的合意管轄裁判所とします。</p>
        </section>
