  ...
  return (
    <main className="min-h-screen bg-black text-white p-6">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <p className="text-gray-300 text-sm">{`{事業者名}`}（以下「当社」）は、本サービスの提供に際し取得する情報の取扱いについて、以下のとおり定めます。</p>
        ...
        <section>
          ...
          <p className="text-gray-300 text-sm">法令に基づく場合等を除き、本人の同意なく第三者へ提供しません。決済処理は Stripe に委託し、カード情報は Stripe により安全に処理されます。</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-2">4. 安全管理措置</h2>
          <p className="text-gray-300 text-sm">サーバー・アプリケーションのアクセス制御、通信の暗号化、ログ監査等、適切な安全管理措置を講じます。</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-2">5. 開示・訂正・削除</h2>
          <p className="text-gray-300 text-sm">ご本人からの保有個人データに関する開示・訂正・削除の請求に、法令に基づき適切に対応します。問い合わせは下記窓口までご連絡ください。</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-2">6. 改定</h2>
          <p className="text-gray-300 text-sm">本ポリシーは予告なく改定する場合があります。改定後は当ページに掲示します。</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-2">7. 連絡先</h2>
          <p className="text-gray-300 text-sm">ueno@uenodesign.site</p>
        </section>
